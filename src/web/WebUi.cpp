...
<h1>FPVCineCam32 <small>v0.9.3</small></h1><div class=sub>Blackmagic + Betaflight MSP development build</div>
...
<p><b>Status message:</b> <span id=osdLive class=muted>Waiting...</span></p><p class=muted>v0.9.3 sends REC/STBY to the selected Custom Message slot. The next Custom Message slot is reserved for media remaining (intentionally shown as MEDIA -- while the media decoder is disabled for this diagnostic build).</p>
</div>
